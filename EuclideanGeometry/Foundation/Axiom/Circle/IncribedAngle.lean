...
theorem arc_center_isnot_arc_endpts (β : Arc P) : Isnot_arc_endpts β.center β := sorry

theorem isint_arc_isnot_arc_endpts {β : Arc P} {p : P} (h : p LiesInt β) : Isnot_arc_endpts p β := sorry
...
theorem isint_complementary_arc_isnot_arc_endpts {β : Arc P} {p : P} (h : p LiesInt β.complement) : Isnot_arc_endpts p β := sorry
...
def cangle (β : Arc P) : Angle P := angle_mk_pt_arc β.center β (arc_center_isnot_arc_endpts β)
...
theorem inscribed_angle_of_complementary_arc_is_negative {p : P} {β : Arc P} (h : p LiesInt β) : (angle_mk_pt_arc p β (isint_arc_isnot_arc_endpts h)).value.IsNeg := sorry
...
-/
theorem inscribed_angle_on_same_arc_is_invariant {A B : P} {β : Arc P} (h₁ : A LiesInt β) (h₂ : B LiesInt β) : (angle_mk_pt_arc A β (isint_arc_isnot_arc_endpts h₁)).value = (angle_mk_pt_arc B β (isint_arc_isnot_arc_endpts h₂)).value := sorry
...
theorem inscribed_angle_on_complementary_arc_difference_eq_pi {A B : P} {β : Arc P} (h₁ : A LiesInt β) (h₂ : B LiesInt β.complement) : (angle_mk_pt_arc A β (isint_arc_isnot_arc_endpts h₁)).value - (angle_mk_pt_arc B β (isint_complementary_arc_isnot_arc_endpts h₂)).value = π := sorry
