...
/- AA -/
theorem sim_of_AA (tr₁ tr₂ : Triangle_nd P) (h₂ : tr₁.oangle₂.value = tr₂.oangle₂.value) (h₃ : tr₁.oangle₃.value = tr₂.oangle₃.value) : tr₁ ∼ tr₂ := sorry 

theorem asim_of_AA (tr₁ tr₂ : Triangle_nd P) (h₂ : tr₁.oangle₂.value = - tr₂.oangle₂.value) (h₃ : tr₁.oangle₃.value = - tr₂.oangle₃.value) : tr₁ ∼ₐ tr₂ := sorry
