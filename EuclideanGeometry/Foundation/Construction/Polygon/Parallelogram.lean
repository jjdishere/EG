...
theorem is_prg_of_para_para_abstract (h₁ : qdr_cvx.edge_nd₁₂ ∥ qdr_cvx.edge_nd₃₄) (h₂ : qdr_cvx.edge_nd₁₄ ∥ qdr_cvx.edge_nd₂₃) : qdr_cvx.IsParallelogram := by
...
theorem is_prg_of_eq_length_eq_length_abstract (h₁ : (qdr_cvx.edge_nd₁₂).1.length = (qdr_cvx.edge_nd₃₄).1.length) (h₂ : qdr_cvx.edge_nd₁₄.1.length = qdr_cvx.edge_nd₂₃.1.length) : qdr_cvx.IsParallelogram := sorry
...
theorem is_prg_of_para_eq_length_abstract (h₁ : qdr_cvx.edge_nd₁₂ ∥ qdr_cvx.edge_nd₃₄) (h₂ : qdr_cvx.edge_nd₁₂.1.length = qdr_cvx.edge_nd₃₄.1.length) : qdr_cvx.IsParallelogram := sorry
...
/-- Given Quadrilateral_cvx qdr_cvx, and qdr_cvx.edge_nd₁₄ ∥ qdr_cvx.edge_nd₂₃ and (qdr_cvx.edge_nd₁₄).1.length = (qdr_cvx.edge_nd₂₃).1.length, qdr_cvx is a Parallelogram. -/
theorem is_prg_of_para_eq_length'_abstract (h₁ : qdr_cvx.edge_nd₁₄ ∥ qdr_cvx.edge_nd₂₃) (h₂ : qdr_cvx.edge_nd₁₄.1.length = qdr_cvx.edge_nd₂₃.1.length) : qdr_cvx.IsParallelogram := sorry
...
theorem is_convex_of_is_prg_abstract (h : qdr.IsParallelogram) : qdr.IsConvex := by
...
theorem nd₁₃_of_is_prg_abstract (h : qdr.IsParallelogram) : qdr.point₃ ≠ qdr.point₁ := by
  have s : qdr.IsConvex:= is_convex_of_is_prg h
...
theorem para_of_is_prg_abstract (h : qdr.IsParallelogram) : (SEG_nd qdr.point₁ qdr.point₂ (nd₁₂_of_is_prg_abstract qdr h)) ∥ (SEG_nd qdr.point₃ qdr.point₄ (nd₃₄_of_is_prg_abstract qdr h)):= by
  unfold Quadrilateral.IsParallelogram at h
...
/-- Given Quadrilateral qdr IsPRG, the opposite sides are parallel namely (SEG_nd qdr.point₁ qdr.point₄ (nd₁₄_of_is_prg_abstract qdr h)) ∥ (SEG_nd qdr.point₂ qdr.point₃ (nd₂₃_of_is_prg_abstract qdr h)). -/
theorem para_of_is_prg'_abstract (h : qdr.IsParallelogram) : (SEG_nd qdr.point₁ qdr.point₄ (nd₁₄_of_is_prg_abstract qdr h)) ∥ (SEG_nd qdr.point₂ qdr.point₃ (nd₂₃_of_is_prg_abstract qdr h)):= by
  unfold Quadrilateral.IsParallelogram at h
  by_cases k: qdr.IsConvex
  simp only [k, dite_true] at h
  unfold Quadrilateral_cvx.IsParallelogram at h
...
theorem eq_length_of_is_prg_abstract  (h : qdr.IsParallelogram) : (SEG_nd qdr.point₁ qdr.point₂ (nd₁₂_of_is_prg_abstract qdr h)).1.length = (SEG_nd qdr.point₃ qdr.point₄ (nd₃₄_of_is_prg_abstract qdr h)).1.length := by
  unfold Quadrilateral.IsParallelogram at h
  by_cases k: qdr.IsConvex
  simp only [k, dite_true] at h
  sorry
...
/-- Given Quadrilateral qdr IsPRG, the opposite sides are equal namely (SEG_nd qdr.point₁ qdr.point₄ (nd₁₄_of_is_prg_abstract qdr h)).1.length = (SEG_nd qdr.point₂ qdr.point₃ (nd₂₃_of_is_prg_abstract qdr h)).1.length. -/
theorem eq_length_of_is_prg'_abstract  (h : qdr.IsParallelogram) : (SEG_nd qdr.point₁ qdr.point₄ (nd₁₄_of_is_prg_abstract qdr h)).1.length = (SEG_nd qdr.point₂ qdr.point₃ (nd₂₃_of_is_prg_abstract qdr h)).1.length := by
  unfold Quadrilateral.IsParallelogram at h
  by_cases k: qdr.IsConvex
  simp only [k, dite_true] at h
  sorry
...
theorem eq_angle_value_of_is_prg_abstract (h : qdr.IsParallelogram) : ANG qdr.point₁ qdr.point₂ qdr.point₃ ((nd₁₂_of_is_prg_abstract qdr h).symm) (nd₂₃_of_is_prg_abstract qdr h) = ANG qdr.point₃ qdr.point₄ qdr.point₁ ((nd₃₄_of_is_prg_abstract qdr h).symm) ((nd₁₄_of_is_prg_abstract qdr h).symm) := by
  unfold Quadrilateral.IsParallelogram at h
  sorry
...
/-- Given Quadrilateral qdr IsPRG, the opposite angles are equal namely ANG qdr.point₄ qdr.point₁ qdr.point₂ = ANG qdr.point₂ qdr.point₃ qdr.point₄. -/
theorem eq_angle_value_of_is_prg'_abstract (h : qdr.IsParallelogram) : ANG qdr.point₄ qdr.point₁ qdr.point₂ ((nd₁₄_of_is_prg_abstract qdr h)) ((nd₁₂_of_is_prg_abstract qdr h)) = ANG qdr.point₂ qdr.point₃ qdr.point₄ ((nd₂₃_of_is_prg_abstract qdr h).symm) (nd₃₄_of_is_prg_abstract qdr h):= by
  unfold Quadrilateral.IsParallelogram at h
  sorry
...
theorem eq_midpt_of_diag_inx_of_is_prg_abstract {E : P} (h : qdr.IsParallelogram) : Quadrilateral_cvx.diag_inx (QDR_cvx qdr.point₁ qdr.point₂ qdr.point₃ qdr.point₄ (is_convex_of_is_prg_abstract qdr h)) = (SEG qdr.point₁ qdr.point₃).midpoint :=
  sorry
...
/-- Given Quadrilateral qdr IsPRG, the intersection of diagonals is the midpoint of one diagonal namely Quadrilateral_cvx.diag_inx QDR_cvx qdr.point₁ qdr.point₂ qdr.point₃ qdr.point₄ = (SEG qdr.point₂ qdr.point₄).midpoint. -/
theorem eq_midpt_of_diag_inx_of_is_prg'_abstract {E : P} (h : qdr.IsParallelogram) : Quadrilateral_cvx.diag_inx (QDR_cvx qdr.point₁ qdr.point₂ qdr.point₃ qdr.point₄ (is_convex_of_is_prg_abstract qdr h)) = (SEG qdr.point₂ qdr.point₄).midpoint :=
  sorry
