...
example (tr : Triangle P) (nontriv : tr.is_nontriv) (A B C D E F : P) (ha : A LiesOnRay (tr.edge₂.extension_ray nontriv.2)) (hb : B LiesOnRay (tr.edge₃.reverse.extension_ray (Ne.symm nontriv.3))) (hc : C LiesOnRay (tr.edge₁.extension_ray nontriv.1)) (hd : D LiesOnRay)
