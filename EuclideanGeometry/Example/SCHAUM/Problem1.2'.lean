...
-/
  ...
  -- We have $A \ne B$.
  have A_ne_B : e.A ≠ e.B := (ne_of_not_collinear e.not_collinear_ABC).2.2.symm
  -- We have $A \ne C$.
  have A_ne_C : e.A ≠ e.C := (ne_of_not_collinear e.not_collinear_ABC).2.1
  -- We have $C \ne B$.
  ...
  -- We have $Q \ne E$.
  have Q_ne_E : e.Q ≠ e.E := (ne_of_not_collinear not_collinear_QCE).2.1
  -- We have $Q \ne C$.
  have Q_ne_C : e.Q ≠ e.C := (ne_of_not_collinear not_collinear_QCE).2.2.symm
  -- Therefore, $\angle DBP = \angle ABC = -\angle ACB = - \angle ECQ$.
  ...
  have h : (TRI_nd e.P e.B e.D not_collinear_PBD) ≅ₐ (TRI_nd e.Q e.C e.E not_collinear_QCE) := by
