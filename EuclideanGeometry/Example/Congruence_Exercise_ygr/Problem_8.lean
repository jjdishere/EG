...
variable {A B C O : Plane} {hnd1 : ¬ colinear O A B} {hnd2 : ¬ colinear O B C} {hnd3 : ¬ colinear O C A}
-- nondegenerate
...
-- State the main goal.
lemma hnd4 : ¬ colinear O P D := by sorry
lemma hnd5 : ¬ colinear O P E := by sorry
