...
In this file, we define the concept of lines.
  ...
  Classes : 
    class of Line -- A line is a subset of the plane P that satisfies three properties, namely colinarity - every 3 pts on line collinear; maximality - pt that collinear with 2 different pts on line falls on the line; nontriviality - a line contains at least 2 pts
