...
## Project Detail
Team D 1 : Fills sorry's in Plane.lean, section length, and section existence in Ray.lean.

Team A 2 : Fills sorry's in section coersion_compatibility and section midpoint Ray.lean

Team F 3 : Fills sorry's in Ray_ex.lean `Near Finished` `More to be assigned`

Team C 4 : Fills sorry's in Line.lean

Team E 5 : Fills sorry's in Line_ex.lean

Team H 6 : Fills sorry's in Perpendicular.lean `Finished`
Fills sorry's in cosine theorem and prove SAS in congreunce .lean 

Team G 7 : Fills sorry's in Congruence.lean, but you may leave SAS blank and use SAS (and cosine theorem, sine theorem) to show other triangle congruence criteria.

Team B 8 : Fills sorry's in IsocelesTriangle.lean
